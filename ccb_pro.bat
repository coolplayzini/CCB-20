...
mkdir C:\ccb_pro\system\date
ATTRIB +H "C:\ccb_pro\system\date"
cd C:\ccb_pro\system\date
if not exist "C:\ccb_pro\system\date\%date%" echo. >>%date%.txt
cd C:\ccb_pro\system
mkdir C:\ccb_pro\system\update\check
...
cd C:\ccb_pro\system\update\check
cls
echo   Starte FTP-Transfer
ftp /s:serverstatus.ftp
echo   fertig
if exist "C:\ccb_pro\system\update\check\status.txt" set serverstatus=online && del "C:\ccb_pro\system\update\check\status.txt"
...
echo.
echo.
echo                               -oymNMMMMNdy/`        -oymNMMMMNdy+`    odmmmmmmmmdhy+-                         
echo                             +mMMMMMMMMMMMMMN`     +mMMMMMMMMMMMMMN`   NMMMMMMMMMMMMMMN/                       
echo                           .mMMMMMdo:---/sdMM.   .dMMMMMdo:---/odMM.   NMMMM+...-/hMMMMM/                      
echo                          .NMMMMN:         .:   `mMMMMN/         `:    NMMMM/      mMMMMs                      
echo                          hMMMMM-               yMMMMM:                NMMMM/     .NMMMM:                      
echo                         `MMMMMh               `MMMMMd                 NMMMMy+++oyNMMMh:                       
echo                         -MMMMMs               -MMMMMs                 NMMMMMMMMMMMMMms:                       
echo                         -MMMMMs               .MMMMMy                 NMMMMhooooshMMMMMm-                     
echo                         `MMMMMm                NMMMMN`                NMMMM/      `dMMMMN`                    
echo                         sMMMMMs               oMMMMMy                NMMMM/       +MMMMM.                    
echo                          `dMMMMMd/`     `:sd.   hMMMMMd/`     `:sd.   NMMMM/      :mMMMMd                     
echo                           `sMMMMMMMNddmNMMMM-    oMMMMMMMNddmNMMMM:   NMMMMmddddmNMMMMMh`                     
echo                             .odMMMMMMMMMMMd+      `odMMMMMMMMMMMdo    mMMMMMMMMMMMMNdo-                       
echo                                `-/++o++:-`           `-:++o++:-`      `-:::::::--.` 
echo.
echo.
echo.
...
cls
if exist "C:\ccb_pro\system\update\check\u0.txt" goto sfu1
if exist "C:\ccb_pro\system\update\check\update0.txt" ren "C:\ccb_pro\system\update\check\update0.txt" u0.txt && goto sfu1
cd C:\ccb_pro\system\update\check
echo   Starte FTP-Transfer
ftp -s:Update_Proof.ftp
echo   fertig
echo.
echo.
echo.
...
echo.
:sfu1
if not exist "C:\ccb_pro\system\update\check\update0.txt" echo   Es sind derzeit keine neuen Updates verfuegbar. && echo   Oder sie sind nicht installiert. && echo. && echo. && echo. && echo. && pause && goto menue
if exist "C:\ccb_pro\system\update\check\update0.txt" echo   Es ist ein Update verfuegbar.
echo.
echo.
echo.
echo.
echo.
set /p updateask=Moechten Sie das Update installieren? [J/N] : 
...
echo   fertig
cd C:\ccb_pro\system\update
xcopy ccb_pro_update.exe C:\ccb_pro\
del C:\ccb_pro\system\addons\colorthemes.bat
del C:\ccb_pro\system\addon\colors\*.bat
...
if not exist C:\ccb_pro\system\addons\colorthemes.bat goto color_themes_install
call C:\ccb_pro\system\addons\colorthemes.bat
goto menue
...
mkdir C:\ccb_pro\system\addons\colors
cd C:\ccb_pro\system\addons\
echo   Starte FTP-Transfer
ftp /s:installer_color_themes.ftp
echo   fertig
cd C:\ccb_pro\system\addons\colors
echo   Starte FTP-Transfer fuer addon-ordner : colors
ftp /s:C:\ccb_pro\system\addons\installer_colors.ftp
echo   fertig
cd "C:\ccb_pro\system\Users\%un%"
goto menue
...
if not exist C:\ccb_pro\system\addons\SystemClear.bat goto system_clear_install
call C:\ccb_pro\system\addons\SystemClear.bat
goto menue

:system_clear_install
...
cd C:\ccb_pro\system\addons\
echo   Starte FTP-Transfer
ftp /s:installer_SystemClear.ftp
echo   fertig
goto menue
